...
Below is a sophiscated version of the code, which uses functions.
```{r}
...
age_vector <- generate_age_vector(n_minors = 20, n_adults = 50, n_seniors = 30)
```
Alternatively we can just use the code above within the function.
```{r}
