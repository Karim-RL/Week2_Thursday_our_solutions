...
write_csv(tbi_age, file= here("week_2/live_tutorial/solutions/tidy_tuesday_tbi/raw_data", "tbi_age.csv"))
write_csv(tbi_year, file= here("week_2/live_tutorial/solutions/tidy_tuesday_tbi/raw_data", "tbi_year.csv"))
```
...
write_tsv(totals_table, file = here("week_2/live_tutorial/solutions/tidy_tuesday_tbi/tables", "totals_table.tsv"))
write_csv(totals_table, file = here("week_2/live_tutorial/solutions/tidy_tuesday_tbi/tables", "totals_table.csv"))
```
### Task 3.3
